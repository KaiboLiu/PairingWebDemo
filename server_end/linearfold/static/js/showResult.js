...
var filePath = document.getElementById("path").innerHTML;
console.log(filePath);
fillPage_go(d=40,R=250,circleScale=50,halfOpen=20,inFile=$("#path").text());     // fill text, draw graphs and plots on the right
