...
function svg_load_draw_go(d=40,R=250,circleScale=50,halfOpen=20){
    ...
    var pairingFile = "./demo_data/demo_pairing_for_js_all/combine_pairing_"+seriesNo+"."+seqNo; //"16s.seq13";
...
function fillSeqText(){
    ...
    var seqFile = "./demo_data/demo_rearranged_results_all/combine_"+seriesNo+"."+seqNo;
